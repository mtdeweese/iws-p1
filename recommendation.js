const recommendations = [
    ...
    genre: "Fantasy",
    rating: 4.5,
    cover: "images/mistborn.jpg",
    pros: ["Strong magic system", "World-building", "Plot twists"],
    cons: ["Some parts are a bit slow", "Really needs a reread to catch everything"],
    },
    {
    title: "Red Rising",
    ...
    rating: 4,
    cover: "images/redrising.jpg",
    pros: ["Political", "Emotional characters","Fast-paced"],
    cons: ["Considered the weakest of the series", "Sometimes hard to follow"],
    }
]
